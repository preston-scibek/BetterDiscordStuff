...
module.exports = class linkProfilePicture {
  start() {
    ...
    function LinkProfilePicture({ target }) {
      // check parent's parent as sometimes parent is empty div
      if (target.classList.contains("avatar-3QF_VA") && (target.parentElement.classList.contains("header-S26rhB") || target.parentElement.parentElement.classList.contains("header-S26rhB"))) {
